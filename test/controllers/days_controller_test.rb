...
class DaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create day" do
    assert_difference("Day.count") do
      post days_url, params: { day: { homebase: @day.homebase, location: @day.location, notes: @day.notes, trip_id: @day.trip_id } }
    end
  ...
  test "should update day" do
    patch day_url(@day), params: { day: { homebase: @day.homebase, location: @day.location, notes: @day.notes, trip_id: @day.trip_id } }
